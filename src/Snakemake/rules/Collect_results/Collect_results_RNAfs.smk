...
rule copy_TST170:
    ...
    output:
        ...
        bams = ["TST170_bam/" + s + ".bam" for s in config["RNA_Samples"]],
        bais = ["TST170_bam/" + s + ".bam.bai" for s in config["RNA_Samples"]]
    params:
    ...
    run:
        ...
        for sample in params.samples :
            ...
            #subprocess.call("cp TST170/RNA_IntermediateFiles/Alignment/" + sample + ".bam TST170_bam/" + sample + "/", shell=True)
            #subprocess.call("cp TST170/RNA_IntermediateFiles/Alignment/" + sample + ".bam.bai TST170_bam/" + sample + "/", shell=True)

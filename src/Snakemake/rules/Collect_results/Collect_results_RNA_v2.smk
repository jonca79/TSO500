...
rule copy_TSO500_RNA:
    ...
    output:
        fusions = ["Results/RNA/" + s + "/" + s + "_CombinedVariantOutput.tsv" for s in config["RNA_Samples"]],
    ...
    run:
        ...
        for sample in params.samples :
            ...
            subprocess.call("mv TSO500/Logs_Intermediates/RnaAlignment/" + sample + "/*.bam* RNA_TSO500/" + sample + "/", shell=True)

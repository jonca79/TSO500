...
rule run_TSO500:
    ...
    run:
        ...
        #subprocess.call("mkdir /scratch/TSO500/")
        subprocess.call("/data/illumina/TSO500/TruSight_Oncology_500_1.3.0.singularity.sh --resourcesFolder /data/illumina/TSO500/resources.1.3.0/ --analysisFolder /scratch/$SLURM_JOB_ID/ --runFolder " + params.runfolder + " --sampleSheet " + input.sample_sheet, shell=True)
        subprocess.call("mv /scratch/$SLURM_JOB_ID/ ./TSO500/")

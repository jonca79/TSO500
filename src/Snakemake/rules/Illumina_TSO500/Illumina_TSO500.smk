...
rule run_TSO500:
    ...
    shell :
        "/data/illumina/TSO500/TruSight_Oncology_500_1.3.0.singularity.sh --resourcesFolder /data/illumina/TSO500/resources.1.3.0/ --analysisFolder TSO500 --runFolder ./ --sampleSheet {input.sample_sheet}"

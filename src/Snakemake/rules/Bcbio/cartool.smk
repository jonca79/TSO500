...
rule cartool:
    input:
        bam = "DNA_bam/{sample}-sort-cumi.bam",
        bed = "DATA/TST500C_manifest.bed",
        bai = "DNA_bam/{sample}-sort-cumi.bam.bai"
    output:
    ...
    params:
        user = "Jonas",
        coverage = "100 200 1000",
        extra = "-k" #k = combine, p= mapQ
    log:
        "logs/qc/CARTool/{sample}.cartool.log"
    singularity:
        "/projects/wp2/nobackup/Twist_Myeloid/Containers/CARTools-200206.simg"
